...
*/
setReadOnly( fs, 'appendFile', require( './../append-file' ) );
...
*/
setReadOnly( fs, 'readNDJSON', require( './../read-ndjson' ) );
...
*/
setReadOnly( fs, 'resolveParentPaths', require( './../resolve-parent-paths' ) );
