...
```javascript
import fs from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { close, exists, open, readDir, readFile, readFileList, readJSON, readWASM, rename, resolveParentPath, resolveParentPathBy, unlink, writeFile } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs@v0.1.1-esm/index.mjs';
```
