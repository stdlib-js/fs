...
```javascript
fs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fs@v0.3.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fs@v0.3.3-umd/browser.js"></script>
```
